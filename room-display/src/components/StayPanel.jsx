  ...
  return (
    ...
    >
      <header className="mb-3">
        ...
        <h2 className="text-2xl font-extralight text-ink leading-tight">Your Stay</h2>
      ...
      <div className="flex-1 flex flex-col gap-3 justify-between">
        {/* Unit card */}
        <div
          className="relative h-28 rounded-3xl overflow-hidden flex items-end"
          style={{
        ...
        >
          ...
          <span
            ...
            style={{ top: 6, right: 10, fontSize: '5rem', opacity: 0.16, transform: 'rotate(-8deg)' }}
          >
            villa
          </span>
          <div
          ...
          >
            <span
              className="inline-flex items-center px-4 py-1.5 rounded-full text-base font-extrabold uppercase tracking-widest mb-2 w-fit bg-accent"
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="glass-card p-4 rounded-2xl">
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-dim mb-2.5">Check-in</p>
            <p className="text-2xl font-light text-ink">{fmt(booking.check_in_date)}</p>
            <p className="text-[11px] mt-1.5 text-accent">After 14:00</p>
          </div>
          <div className="glass-card p-4 rounded-2xl">
            <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-dim mb-2.5">Check-out</p>
            <p className="text-2xl font-light text-ink">{fmt(booking.check_out_date)}</p>
            <p className="text-[11px] mt-1.5 text-accent">Before 12:00</p>
          </div>
        </div>
        ...
        {roomControllerEnabled && (
          <div className="glass-card rounded-2xl px-4 py-3">
            <div className="flex items-center justify-between text-[10px] text-faint mb-2 uppercase tracking-widest font-bold">
