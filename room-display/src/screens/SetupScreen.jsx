      ...
      <form onSubmit={handleSubmit} className="glass-card rounded-3xl p-12 w-96 flex flex-col gap-6 z-10">
        <div className="text-center mb-2">
          <div className="flex justify-center mb-4">
            <img src="/logo.png" alt="Zahill" style={{ width: 120, height: 120, objectFit: 'contain' }} />
          </div>
          <p className="text-xs font-bold uppercase tracking-[0.3em] mb-2" style={{ color: '#c9a227' }}>Room Display</p>
