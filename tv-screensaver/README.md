...
- Loads `https://tv.d-zahill.kdai.cloud?room=<roomId>&token=<token>`
...
4. Enable the screensaver in Android TV settings and select `Zahill TV Screensaver`.
