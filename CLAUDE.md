...
**Next migration number: 041** (keep `ROADMAP.md` in sync when you add one).
...
- ✅ Room ID decoupled from `room_controller`; calling split into its own `calling` module — migration 040. Fixes real production friction: hardware-less clients previously couldn't set a Room ID or use calling at all.
