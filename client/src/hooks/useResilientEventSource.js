...
// which can miss a connection that died silently (network blip, a router
// dropping an idle NAT mapping) — the socket never gets a clean error, so
// onerror never fires and the app just stops receiving pushes with no
// indication anything is wrong. This wraps EventSource with:
...
// Mirrors room-display/src/useResilientEventSource.js — kept as a separate
// copy since the two apps don't share a package.
